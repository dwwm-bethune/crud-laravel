        ...
        <form action="{{ route('cars.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between">
                <div class="mb-3 w-1/2 mr-6">
                    ...
                    <input type="text" name="brand" id="brand" class="text-gray-900 w-full rounded-lg mb-2" value="{{ old('brand') }}">
                ...
                <div class="mb-3 w-1/2">
                    ...
                    <input type="text" name="model" id="model" class="text-gray-900 w-full rounded-lg mb-2" value="{{ old('model') }}">
            ...
            <div class="mb-3">
                ...
                <textarea id="content" name="content" class="text-gray-900 w-full rounded-lg">{{ old('content') }}</textarea>
            ...
            <div class="mb-3">
                <div class="flex items-center">
                    <input type="checkbox" id="state" name="state" class="mr-3" value="1" @checked(old('state')) />
